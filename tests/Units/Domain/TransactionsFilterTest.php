...
final class TransactionsFilterTest extends TestCase {
    public function test_meta_account(): void {
        /** @var Buyer $buyer */
    ...
    public function test_transfer_meta(): void {
        /**
         * @var Buyer $buyer1
         * @var Buyer $buyer2
         */
    ...
    /**
     * @see https://github.com/ArsamMe/laravel-wallet/issues/501
     */
    public function test_pagination2(): void {
        /** @var Buyer $buyer */
        $buyer = BuyerFactory::new()->create();
        $db = app(DatabaseServiceInterface::class);
        $db->transaction(function () use ($buyer): void {
