...
use ArsamMe\Wallet\Test\Infra\Factories\ItemWalletFactory;
use ArsamMe\Wallet\Test\Infra\Models\Buyer;
use ArsamMe\Wallet\Test\Infra\Models\Item;
use ArsamMe\Wallet\Test\Infra\Models\ItemWallet;
...
final class ProductTest extends TestCase {
    ...
    public function test_pay_custom_price(): void {
        /** @var Buyer $buyer */
        $buyer = BuyerFactory::new()->create();
        /**
         * @var Item $productIn
    ...
    /**
     * @see https://github.com/ArsamMe/laravel-wallet/issues/237
     */
    public function test_product_multi_wallet(): void {
        /** @var Buyer $buyer */
        $buyer = BuyerFactory::new()->create();
