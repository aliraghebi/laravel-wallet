...
use ArsamMe\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowDateListener;
use ArsamMe\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowIdListener;
use ArsamMe\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowUuidListener;
use ArsamMe\Wallet\Test\Infra\Listeners\TransactionCreatedThrowListener;
use ArsamMe\Wallet\Test\Infra\Listeners\WalletCreatedThrowListener;
...
final class EventTest extends TestCase {
    ...
    public function test_balance_updated_throw_date_listener(): void {
     ...
     */
    public function test_balance_not_changed(): void {
        Event::listen(BalanceUpdatedEventInterface::class, BalanceUpdatedThrowIdListener::class);
     ...
     * @throws ExceptionInterface
     */
    public function test_transaction_created_multi_listener(): void {
