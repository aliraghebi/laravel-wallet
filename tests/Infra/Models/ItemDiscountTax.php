...
use ArsamMe\Wallet\Interfaces\Discount;
use ArsamMe\Wallet\Interfaces\ProductLimitedInterface;
use ArsamMe\Wallet\Interfaces\Taxable;
 ...
 * @method int getKey()
 */
final class ItemDiscountTax extends Model implements Discount, ProductLimitedInterface, Taxable {
    use HasWallet;
