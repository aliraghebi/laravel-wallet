...
```php
/**
 * @var \ArsamMe\Wallet\Interfaces\Customer $customer
 * @var \ArsamMe\Wallet\Models\Wallet $wallet
 * @var \ArsamMe\Wallet\Interfaces\ProductInterface $product
 */
...
```php
/** @var \ArsamMe\Wallet\Traits\HasWallets $user */
