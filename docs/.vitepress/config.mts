...
export default defineConfig({
    ...
    themeConfig: {
        ...
        editLink: {
            pattern: 'https://github.com/aliraghebi/laravel-wallet/edit/main/docs/:path'
        },
        nav: [
            {text: 'Home', link: '/'},
            {text: 'Guide', link: '/guide/introduction/'},
            {text: 'Issues', link: 'https://github.com/aliraghebi/laravel-wallet/issues'},
            {text: 'Discussions', link: 'https://github.com/aliraghebi/laravel-wallet/discussions'},
        ...
        sidebar: [
            ...
            },
            {
                text: 'Core Features',
                items: [
                    {text: 'Deposit', link: '/guide/core/deposit'},
                    {text: 'Withdraw', link: '/guide/core/withdraw'},
        ...
        socialLinks: [
            ...
            //   },
            // },
            {icon: 'github', link: 'https://github.com/aliraghebi/laravel-wallet'},
        ],

        footer: {
            message: 'Released under the <a href="https://github.com/aliraghebi/laravel-wallet/blob/master/LICENSE">MIT License</a>.',
            copyright: 'Copyright © 2025-present <a href="https://github.com/aliraghebi">Arsam</a>'
        }
    }
})
